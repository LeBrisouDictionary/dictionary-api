  ...
  S.transaction({
    ...
    function checkDuplicateId(array) {
      ...
      if (!(array instanceof Object)) {
        throw error(500, "add.checkDuplicateId")
      }
        ...
        return Language.find({
          ...
          .then(function (languageObj) {
            if (languageObj === null) {
              ...
              return word.setLanguage(languageObj, {
                lock: "UPDATE",
                transaction: t
              })
            }
        ...
        return Promise.resolve().then(function () {
          ...
          .then(function () {
            ...
            return Hyperlink.findAll({
              where: ["hyperlink IN (\"" + p.hyperlinks.join('","') + "\")"]
            }, {
              transaction: t
            })
          })
          .then(function (hyperlinks) {
            ...
            return word.setHyperlinks(hyperlinks, {
              transaction: t
            })
          })
          .catch(function (err) {
        ...
        return Word.findAll({
          ...
          .then(function (relativesObj) {
            if (relativesObj.length === 0) {
              ...
              return word.setRelatives(relativesObj, {
                transaction: t
              })
            }
          })
        ...
        return Word.findAll({
          ...
          .then(function (synonyms) {
            if (synonyms.length === 0) {
              ...
              return word.setSynonyms(synonyms, {
                transaction: t
              })
            }
          })
        ...
        return Word.findAll({
          ...
          .then(function (antonyms) {
            if (antonyms.length === 0) {
              ...
              return word.setAntonyms(antonyms, {
                transaction: t
              })
            }
          })
    ...
    function insertExamples(definitionObj, examples) {
      if (examples) {
        ...
        return Example.bulkCreate(examples.map(function (n) {
            return {
              example: n
            }
          }), {
          ...
          .then(function (examples) {
            return definitionObj.setExamples(examples, {
              lock: "UPDATE",
              transaction: t
            })
          })
    ...
    function setWordDefinitions() {
      if (tempDefinitionsObjects.length) {
        return word.setDefinitions(tempDefinitionsObjects, {
          transaction: t
        })
      }
    }
        ...
        return p.countries.reduce(function (next, country) {
          return next
            ...
            .then(function (countryObj) {
              ...
              return word.addCountry(countryObj, {
